  ...
  return (
    <aside className="w-64 bg-gray-900 text-white min-h-screen flex flex-col">
      ...
      <nav className="flex-1 p-4 space-y-2">
        <Link href="/factufly" className="block px-4 py-2 hover:bg-gray-800 rounded">
          Dashboard
        </Link>
        <div className="pt-4 pb-2 px-4 text-xs uppercase text-gray-500 font-semibold">
          Módulos
        </div>
        <Link href="/factufly/facturacion" className="block px-4 py-2 hover:bg-gray-800 rounded">
          Facturación
        </Link>
        <Link href="/factufly/inventario" className="block px-4 py-2 hover:bg-gray-800 rounded">
          Inventario
        </Link>
        <Link href="/factufly/clientes" className="block px-4 py-2 hover:bg-gray-800 rounded">
          Clientes
        </Link>
      </nav>
