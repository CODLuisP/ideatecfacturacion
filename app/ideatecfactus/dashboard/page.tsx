...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      {/* Recent Documents */}
      <Card title="Comprobantes Recientes" action={<Button variant="ghost" className="text-brand-blue" onClick={() => router.push('/ideatecfactus/emision')}>Ver todos <ChevronRight className="w-4 h-4" /></Button>}>
