        ...
        <div className="lg:col-span-2 space-y-6">
          <Card title="Datos de la Nota de Crédito" subtitle="Completa la información requerida">
            <form className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <div className="flex gap-2">
                    ...
                    <input type="text" disabled value="0000012" className="w-2/3 py-2.5 bg-gray-100 border border-gray-200 rounded-xl px-4 text-gray-500 font-mono" />
                  </div>
                </div>
                <div className="space-y-1.5">
              ...
              {/* Monto a acreditar */}
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-gray-500 uppercase">Monto a Acreditar</label>
        ...
        <div className="space-y-6">
          <Card title="Vista Previa" subtitle="Representación gráfica del comprobante">
            ...
            <div className="mt-6 space-y-3">
              <Button className="w-full py-3 text-base">Emitir Nota de Crédito</Button>
