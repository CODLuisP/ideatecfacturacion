...
import { FileText, AlertCircle, Plus, Truck } from 'lucide-react';

const documentTypes = [
  { title: 'Factura Electrónica', desc: 'Para empresas y negocios con RUC (con derecho a crédito fiscal).', icon: FileText,    href: '/ideatecfactus/emision/factura'},
  { title: 'Boleta de Venta',     desc: 'Para personas naturales y consumidores finales sin RUC.',          icon: FileText,    href: '/ideatecfactus/emision/boleta'       },
  { title: 'Nota de Crédito',     desc: 'Para anular o modificar comprobantes emitidos previamente.',       icon: AlertCircle, href: '/ideatecfactus/emision/nota-credito' },
  { title: 'Nota de Débito',      desc: 'Para aumentar el valor de un comprobante emitido previamente.',    icon: Plus,        href: '/ideatecfactus/emision/nota-debito'  },
  { title: 'Guía de Remisión',    desc: 'Para sustentar el traslado de bienes a nivel nacional.',           icon: Truck,       href: '/ideatecfactus/emision/guia-remision'},
];
